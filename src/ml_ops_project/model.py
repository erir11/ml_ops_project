...
class CarDamageModel(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        scheduler = StepLR(optimizer, step_size=self.hparams.scheduler_step_size, gamma=self.hparams.scheduler_gamma)
    ...
    def on_validation_epoch_end(self):
        ...
        if isinstance(self.logger, pl.loggers.WandbLogger):
            self.logger.experiment.log({"confusion_matrix": wandb.Image(fig), "epoch": self.current_epoch})
    ...
    def on_test_epoch_end(self):
        ...
        if isinstance(self.logger, pl.loggers.WandbLogger):
            self.logger.experiment.log({"test_confusion_matrix": wandb.Image(fig), "epoch": self.current_epoch})
